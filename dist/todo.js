...
/***/ function(module, exports, __webpack_require__) {
	...
	var riot = __webpack_require__(1)
	riot.tag2('todo-app', '<h3>Todos</h3> <todo-form></todo-form> <todo-list></todo-list> <p> Want a second fully synchronized list? Just declare another list component: no code required, no events to wire up! </p> <todo-list></todo-list>', '', '', function(opts) {
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('todo-list', '<ul> <li each="{todo in todos}"> <todo-item todo="{todo}"></todo-item> </li> </ul>', '', 'template="jade"', function(opts) {
	  ...
	  store.subscribe(function () {
	    return _this.todos = store.getState();
	  });
	}, '{ }');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsMapValues = __webpack_require__(13);

	var _utilsMapValues2 = _interopRequireDefault(_utilsMapValues);

	var _utilsPick = __webpack_require__(14);
